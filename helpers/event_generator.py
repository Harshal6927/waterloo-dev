...
class EventGenerator:
    ...
    def _get_location_front_list(self):
        ...
        """
        with open(os.path.join(self.data_path, "location_front.txt")) as f:
    ...
    def _get_city_names(self):
        ...
        """
        with open(os.path.join(self.data_path, "city_names.txt")) as c:
    ...
    def _get_visitng_verbs(self):
        ...
        """
        with open(os.path.join(self.data_path, "visiting_actions.txt")) as v:
            visit = v.readlines()
            visit = [x.replace("\n", "") for x in visit]
    ...
    def _get_winning_verbs(self):
        ...
        """
        with open(os.path.join(self.data_path, "winning_actions.txt")) as w:
            win = w.readlines()
            win = [x.replace("\n", "") for x in win]
