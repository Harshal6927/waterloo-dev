...
class ItemGenerator:
    ...
    def _get_weapon_front_list(self):
        ...
        """
        with open(os.path.join(self.data_path, "weapon_front.txt")) as wf:
    ...
    def _get_helmet_front_list(self):
        ...
        """
        with open(os.path.join(self.data_path, "helmet_front.txt")) as hf:
    ...
    def _get_armor_front_list(self):
        ...
        """
        with open(os.path.join(self.data_path, "armor_front.txt")) as af:
    ...
    def _get_boots_front_list(self):
        ...
        """
        with open(os.path.join(self.data_path, "boots_front.txt")) as bf:
    ...
    def _get_necklace_front_list(self):
        ...
        """
        with open(os.path.join(self.data_path, "necklace_front.txt")) as nf:
    ...
    def _get_item_names(self):
        ...
        """
        with open(os.path.join(self.data_path, "names.txt")) as n:
            names = n.readlines()
