...
class Character:
    ...
    def equip_best(self) -> None:
        ...
        for item in self.inventory:
            item_t = item.type_
            if item_t == "Weapon" and item.enumerate_rarity() > self.equipped_weapon.enumerate_rarity():
                self.equipped_weapon = item
            elif item_t == "Helmet" and item.enumerate_rarity() > self.equipped_helmet.enumerate_rarity():
                self.equipped_helmet = item
            elif item_t == "Armor" and item.enumerate_rarity() > self.equipped_armor.enumerate_rarity():
                self.equipped_armor = item
            elif item_t == "Boots" and item.enumerate_rarity() > self.equipped_boots.enumerate_rarity():
                self.equipped_boots = item
            elif item_t == "Necklace" and item.enumerate_rarity() > self.equipped_necklace.enumerate_rarity():
