...
class CharacterDatabase:
    ...
    def get_character_leaderboard(self):
        ...
        """
        leaderboard = sorted(self.characters.values(), key=lambda char: char.coins, reverse=True)
    ...
    def flush_buffer(self, current_character) -> Character:
        """
        ...
        for b_item in current_character.buffer:
            ...
            for event in b_item.events:
                current_character.quest_log.append(event)
